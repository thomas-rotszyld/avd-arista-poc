...
| Ethernet6 | P2P_LINK_TO_BORDERLEAF1-DC2_Ethernet3 | routed | - | 192.168.203.24/31 | default | 1550 | False | - | - |
| Ethernet7 | P2P_LINK_TO_BORDERLEAF2-DC2_Ethernet3 | routed | - | 192.168.203.30/31 | default | 1550 | False | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 192.168.99.1 | 65000 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
...
| 192.168.203.13 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.19 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.25 | 65299 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.31 | 65299 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor 192.168.203.13 remote-as 65203
   neighbor 192.168.203.13 description leaf3-DC2_Ethernet3
   neighbor 192.168.203.19 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.19 remote-as 65203
   neighbor 192.168.203.19 description leaf4-DC2_Ethernet3
   neighbor 192.168.203.25 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.25 remote-as 65299
   neighbor 192.168.203.25 description borderleaf1-DC2_Ethernet3
   neighbor 192.168.203.31 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.31 remote-as 65299
   neighbor 192.168.203.31 description borderleaf2-DC2_Ethernet3
