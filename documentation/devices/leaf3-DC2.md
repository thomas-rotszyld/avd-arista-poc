...
| --------- | --------------- | ------------ | --------- |
| dc2_mlag2 | Vlan4094 | 192.168.93.5 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_leaf4-DC2_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_leaf4-DC2_Ethernet2 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | host2-DC2_Ethernet1 | *access | *200 | *- | *- | 6 |
| Ethernet7 | host2-DC2_Ethernet2 | *access | *200 | *- | *- | 6 |
...
!
interface Ethernet6
   description host2-DC2_Ethernet1
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description host2-DC2_Ethernet2
   no shutdown
   channel-group 6 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_leaf4-DC2_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel6 | host2-DC2_PortChannel host2 | switched | access | 200 | - | - | - | - | 6 | - |
...
| Vlan3009 |  Red_1  |  192.168.94.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Blue_1  |  192.168.94.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.168.94.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.93.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 192.168.94.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 192.168.94.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Blue_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.94.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Blue_1 | 192.168.201.3:20 | 20:20 | - | - | learned | 100,200 |
| Red_1 | 192.168.201.3:10 | 10:10 | - | - | learned | 10,20 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Blue_1 | 192.168.201.3:20 | connected |
| Red_1 | 192.168.201.3:10 | connected |
...
router bgp 65203
   ...
   neighbor 192.168.94.5 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.94.5 description leaf4-DC2
