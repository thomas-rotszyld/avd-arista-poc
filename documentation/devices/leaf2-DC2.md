...
| --------- | --------------- | ------------ | --------- |
| dc2_mlag1 | Vlan4094 | 192.168.93.0 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_leaf1-DC2_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_leaf1-DC2_Ethernet2 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | host1-DC2_Ethernet3 | *access | *20 | *- | *- | 6 |
| Ethernet7 | host1-DC2_Ethernet4 | *access | *20 | *- | *- | 6 |
...
!
interface Ethernet6
   description host1-DC2_Ethernet3
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description host1-DC2_Ethernet4
   no shutdown
   channel-group 6 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_leaf1-DC2_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel6 | host1-DC2_PortChannel host2-DC1 | switched | access | 20 | - | - | - | - | 6 | - |
...
| Vlan3009 |  Red_1  |  192.168.94.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Blue_1  |  192.168.94.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.168.94.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.93.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 192.168.94.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 192.168.94.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Blue_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.94.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Blue_1 | 192.168.201.2:20 | 20:20 | - | - | learned | 100,200 |
| Red_1 | 192.168.201.2:10 | 10:10 | - | - | learned | 10,20 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Blue_1 | 192.168.201.2:20 | connected |
| Red_1 | 192.168.201.2:10 | connected |
...
router bgp 65201
   ...
   neighbor 192.168.94.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.94.0 description leaf1-DC2
