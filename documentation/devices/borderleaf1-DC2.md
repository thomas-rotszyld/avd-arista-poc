...
| --------- | --------------- | ------------ | --------- |
| dc2_mlag3 | Vlan4094 | 192.168.93.9 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_borderleaf2-DC2_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_borderleaf2-DC2_Ethernet2 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_borderleaf2-DC2_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| Vlan3009 |  Red_1  |  192.168.94.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Blue_1  |  192.168.94.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.168.94.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.93.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| 192.168.203.24 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.26 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.28 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.94.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Blue_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.94.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Blue_1 | 192.168.201.5:20 | 20:20 | - | - | learned | 100,200 |
| Red_1 | 192.168.201.5:10 | 10:10 | - | - | learned | 10,20 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Blue_1 | 192.168.201.5:20 | connected |
| Red_1 | 192.168.201.5:10 | connected |
...
router bgp 65299
   ...
   neighbor 192.168.203.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.24 remote-as 65200
   neighbor 192.168.203.24 description spine1-DC2_Ethernet6
   neighbor 192.168.203.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.26 remote-as 65200
   neighbor 192.168.203.26 description spine2-DC2_Ethernet6
   neighbor 192.168.203.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.28 remote-as 65200
   neighbor 192.168.203.28 description spine3-DC2_Ethernet6
