...
| --------- | --------------- | ------------ | --------- |
| dc1_mlag1 | Vlan4094 | 192.168.90.1 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_leaf2-DC1_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_leaf2-DC1_Ethernet2 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | host1-DC1_nic1 | *access | *10 | *- | *- | 6 |
| Ethernet7 | host1-DC1_nic2 | *access | *10 | *- | *- | 6 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_leaf2-DC1_Po1 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel6 | host1-DC1_PortChannel to host1-DC1 | switched | access | 10 | - | - | - | - | 6 | - |
...
| Vlan3009 |  Red_1  |  192.168.91.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Blue_1  |  192.168.91.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.168.91.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.90.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 192.168.91.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 192.168.91.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Blue_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.91.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Blue_1 | 192.168.101.1:20 | 20:20 | - | - | learned | 100,200 |
| Red_1 | 192.168.101.1:10 | 10:10 | - | - | learned | 10,20 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Blue_1 | 192.168.101.1:20 | connected |
| Red_1 | 192.168.101.1:10 | connected |
...
router bgp 65101
   ...
   neighbor 192.168.91.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.91.1 description leaf2-DC1
