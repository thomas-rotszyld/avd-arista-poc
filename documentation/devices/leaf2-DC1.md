...
| --------- | --------------- | ------------ | --------- |
| dc1_mlag1 | Vlan4094 | 192.168.90.0 | Port-Channel1 |
...
| Ethernet6 | host1-DC1_nic3 | *access | *10 | *- | *- | 6 |
| Ethernet7 | host1-DC1_nic4 | *access | *10 | *- | *- | 6 |
...
!
interface Ethernet6
   description host1-DC1_nic3
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description host1-DC1_nic4
   no shutdown
   channel-group 6 mode active
```
...
| Vlan3009 |  Red_1  |  192.168.91.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Blue_1  |  192.168.91.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.168.91.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.90.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 192.168.91.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 192.168.91.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Blue_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.91.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Blue_1 | 192.168.101.2:20 | 20:20 | - | - | learned | 100,200 |
| Red_1 | 192.168.101.2:10 | 10:10 | - | - | learned | 10,20 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Blue_1 | 192.168.101.2:20 | connected |
| Red_1 | 192.168.101.2:10 | connected |
...
router bgp 65101
   ...
   neighbor 192.168.91.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.91.0 description leaf1-DC1
